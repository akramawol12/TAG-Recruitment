...
export default function StatusScreen({ status, userName, onLogout }: StatusScreenProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onLogout}
        className="inline-flex items-center gap-2 py-2.5 px-5 border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-slate-700 font-bold rounded-xl transition-all cursor-pointer shadow-sm text-sm"
        id="btn-logout"
      >
